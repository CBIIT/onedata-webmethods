                          <table cellspacing="0" cellpadding="0" summary="" bordercolor="orange" border="0">
                            <tr>
                              <td align="left" height="20" class="dataTablePrimaryLabel">REST API Listing</td>
                            </tr>
                            <tr>
                              <td>
                                <table width="100%" class="dataTable" border="0" cellspacing="0" cellpadding="3" summary="Data Summary">
                                  <tr>
                                    ...
                                    <th align="center" scope="col" class="dataTableHeader">Description</th>
                                    ...
                                    <th align="center" scope="col" class="dataTableHeader">Swagger Document</th>
                                  </tr>
                                  %loop apilist/rest%
                                  <tr class="dataRowLight">
                                    ...
                                    <td nowrap="off" class="dataCellText">%value info/description encode(none)%</td>
