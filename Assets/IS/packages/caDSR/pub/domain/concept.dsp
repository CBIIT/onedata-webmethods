%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">Concept</td>
	</tr>
...
%include latestversionindicator.dsp%
        ...
        <tr>
          <td class="oddrow"><label for="definitionSource">definitionSource</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idefinitionSource" id="definitionSource" class="formFieldSized ">
          </td>
	</tr>
        <tr>
          <td class="oddrow"><label for="evsSource">evsSource</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ievsSource" id="evsSource" class="formFieldSized ">
          </td>
	</tr>
        <tr>
		...
		<option value="Registrations">registrations (gov.nih.nci.cadsr.domain.Registration)</option>
		<option value="Concept">gov.nih.nci.cadsr.domain.Concept</option>
		<option value="ReferenceDocument">referenceDocumentCollection (gov.nih.nci.cadsr.domain.ReferenceDocument)</option>
		<option value="ComponentConcept">componentConceptCollection (gov.nih.nci.cadsr.domain.ComponentConcept)</option>
        ...
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="Concept" id="selectedDomain">
