%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">DataElementConcept</td>
	</tr>	   	
...
%include latestversionindicator.dsp%
	     ...
	     <select tabindex="100" class="formFieldSized" size="1" name="searchObj" id="searchObj" style="width90%">
   		...
   		<option value="AdministeredComponentContract">administeredComponentContactCollection (gov.nih.nci.cadsr.domain.AdministeredComponentContact)</option>
   		...
   		<option value="Property">property (gov.nih.nci.cadsr.domain.Property)</option>
   		...
   		<option value="DataElementConcept">gov.nih.nci.cadsr.domain.DataElementConcept</option>
   		...
   		<option value="ObjectClass">objectClass (gov.nih.nci.cadsr.domain.ObjectClass)</option>
   		<option value="Designation">designationCollection (gov.nih.nci.cadsr.domain.Designation)</option>
	    </select>
          </td>
	</tr>
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="DataElementConcept" id="selectedDomain">
%include footer.dsp%
