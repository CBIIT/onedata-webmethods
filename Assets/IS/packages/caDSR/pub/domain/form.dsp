%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">Form</td>
	</tr>		   	
...
%include latestversionindicator.dsp%			   	
        ...
        <tr>
          <td class="oddrow"><label for="displayName">displayName</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idisplayName" id="displayName" class="formFieldSized ">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="oddrow-l" width="90%">
   		...
   		<option value="Form">gov.nih.nci.cadsr.domain.Form</option>
   		<option value="Module">moduleCollection (gov.nih.nci.cadsr.domain.Module)</option>
   		<option value="ReferenceDocument">referenceDocumentCollection (gov.nih.nci.cadsr.domain.ReferenceDocument)</option>
   		<option value="Conext">context (gov.nih.nci.cadsr.domain.Context)</option>
        ...
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="Form" id="selectedDomain">
%include footer.dsp%
