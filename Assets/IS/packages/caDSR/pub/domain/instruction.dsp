%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">Instruction</td>
	</tr>
...
%include latestversionindicator.dsp%
		...
		<option value="FormElement">formElement (gov.nih.nci.cadsr.domain.FormElement)</option>
		...
		<option value="Instruction">gov.nih.nci.cadsr.domain.Instruction</option>
        ...
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="Instruction" id="selectedDomain">
%include footer.dsp%
