%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">ValueDomain</td>
	</tr>
...
%include latesversionindicator.dsp%
        <tr>
        ...
        <tr>
          <td class="oddrow"><label for="datatypeAnnotation">datatypeAnnotation</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idatatypeAnnotation" id="datatypeAnnotation" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="datatypeDescription">datatypeDescription</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idatatypeDescription" id="datatypeDescription" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="datatypeName">datatypeName</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idatatypeName" id="datatypeName" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="datatypeSchemeReference">datatypeSchemeReference</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idatatypeSchemeReference" id="datatypeSchemeReference" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="decimalPlace">decimalPlace</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idecimalPlace" id="decimalPlace" class="formFieldSized int_long">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="formatName">formatName</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iformatName" id="formatName" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="highValueNumber">highValueNumber</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ihighValueNumber" id="highValueNumber" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="lowValueNumber">lowValueNumber</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ilowValueNumber" id="lowValueNumber" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="maximumLengthNumber">maximumLengthNumber</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="imaximumLengthNumber" id="maximumLengthNumber" class="formFieldSized int_long">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="minimumLengthNumber">minimumLengthNumber</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iminimumLengthNumber" id="minimumLengthNumber" class="formFieldSized int_long">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="UOMName">UOMName</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iUOMName" id="UOMName" class="formFieldSized ">
          </td>
        </tr>
        <tr>
        ...
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="NonenumeratedValueDomain" id="selectedDomain">
%include footer.dsp%
