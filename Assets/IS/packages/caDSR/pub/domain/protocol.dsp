...
%include latestversionindicator.dsp%
        ...
        <tr>
        <tr>
          <td class="oddrow"><label for="approvedBy">approvedBy</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iapprovedBy" id="approvedBy" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="approvedDate">approvedDate</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iapprovedDate" id="approvedDate" class="formFieldSized date">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="changeNumber">changeNumber</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ichangeNumber" id="changeNumber" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="changeType">changeType</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ichangeType" id="changeType" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="leadOrganizationName">leadOrganizationName</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ileadOrganizationName" id="leadOrganizationName" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="phase">phase</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iphase" id="phase" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="protocolID">protocolID</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="iprotocolID" id="protocolID" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="reviewedBy">reviewedBy</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ireviewedBy" id="reviewedBy" class="formFieldSized ">
          </td>
        <tr>
        <tr>
          <td class="oddrow"><label for="reviewedDate">reviewedDate</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ireviewedDate" id="reviewedDate" class="formFieldSized date">
          </td>
        <tr>
        <tr>
        ...
        <tr>
  		...
  		<option value="Definition">definitionCollection (gov.nih.nci.cadsr.domain.Definition)</option>
   		<option value="Protocol">gov.nih.nci.cadsr.domain.Protocol</option>
   		...
   		<option value="Form">formCollection (gov.nih.nci.cadsr.domain.Form)</option>
   		<option value="Designation">designationCollection (gov.nih.nci.cadsr.domain.Designation)</option>
	    </select>
          </td>
        <tr>
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="Protocol" id="selectedDomain">
%include footer.dsp%
