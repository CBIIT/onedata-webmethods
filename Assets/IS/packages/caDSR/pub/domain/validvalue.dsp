...
%include latestversionindicator.dsp%
        ...
        <tr>
          <td class="oddrow"><label for="meaningText">meaningText</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="imeaningText" id="meaningText" class="formFieldSized ">
          </td>
        </tr>
        <tr>
...
<!--  		<option>conditionComponent (gov.nih.nci.cadsr.domain.QuestionConditionComponents)</option>-->
        ...
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="ValidValue" id="selectedDomain">
%include footer.dsp%
