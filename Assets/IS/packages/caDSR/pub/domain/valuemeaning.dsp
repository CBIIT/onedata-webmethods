%include header.dsp%
        <tr>
          <td class="heading" height="20" colspan="3">ValueMeaning</td>
	</tr>
...
%include latestversionindicator.dsp%
        ...
        <tr>
          <td class="oddrow"><label for="comments">comments</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="icomments" id="comments" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="description">description</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="idescription" id="description" class="formFieldSized ">
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="shortMeaning">shortMeaning</label></td>
          <td class="oddrow-l" width="90%">
            <input type="text" name="ishortMeaning" id="shortMeaning" class="formFieldSized ">
          </td>
        </tr>
        <tr>
	    ...
	    <select tabindex="100" class="formFieldSized" size="1" name="searchObj" id="searchObj" style="width90%">
   		...
   		<option value="ValueMeaning">gov.nih.nci.cadsr.domain.ValueMeaning</option>
   		<option value="PermissibleValue">permissibleValueCollection (gov.nih.nci.cadsr.domain.PermissibleValue)</option>
   	...
   	<!--	<option value="ConceptDerivationRule">conceptDerivationRule (gov.nih.nci.cadsr.domain.ConceptDerivationRule)</option>-->
 		...
 		<option value="AdministeredComponentClassSchemeItem">administeredComponentClassSchemeItemCollection (gov.nih.nci.cadsr.domain.AdministeredComponentClassSchemeItem)</option>
  		<option value="Designation">designationCollection (gov.nih.nci.cadsr.domain.Designation)</option>
   		<option value="ConceptualDomain">conceptualDomainCollection (gov.nih.nci.cadsr.domain.ConceptualDomain)</option>
  	    </select>
          </td>
        </tr>
        %include submit.dsp%
    <input type="hidden" name="selectedDomain" value="ValueMeaning" id="selectedDomain">
%include footer.dsp%
