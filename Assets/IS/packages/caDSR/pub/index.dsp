...
<pre><a href="%value /serverInfo/protocol%://%value /serverInfo/host%/invoke/caDSR/GetXML?DataElement[@publicId=62]&returnHeavyXML=true" target="_blank" rel="noopener noreferrer">%value /serverInfo/protocol%://%value /serverInfo/host%/invoke/caDSR/GetXML?DataElelemt[@publicId=62]&returnHeavyXML=true</a></pre>
